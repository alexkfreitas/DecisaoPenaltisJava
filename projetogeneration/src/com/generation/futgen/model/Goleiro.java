		...
		if(potencia==3) {
			...
			if(i==1) {
				...
				if(cantodefesa==canto) {
					...
					TimeUnit.SECONDS.sleep(1);
					System.out.println("O "+this.getNomeJogador().toUpperCase()+" ATÉ ACERTOU O CANTO, MAS O CHUTE FOI MUITO FORTE! INDEFENSÁVEL!");
					return true;
				} else {
					System.out.println("GOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLLLLLLlllllL!");
					TimeUnit.SECONDS.sleep(1);
					System.out.println("MAS NEM SE O "+this.getNomeJogador().toUpperCase()+" ACERTASSE O CANTO CONSEGUIRIA DEFENDER ESSA BOLA! O CHUTE FOI MUITO FORTE!");
					return true;
				}
		...
		// POTENCIA MÉDIA
			...
			if(i==1) {
				...
				if(canto==cantodefesa) {
					...
					TimeUnit.SECONDS.sleep(1);
					System.out.println("O "+this.getNomeJogador().toUpperCase()+ " ATÉ ACERTOU O CANTO, MAS O CHUTE FOI MUITO BEM COLOCADO!");
					return true;
				} else if (canto-cantodefesa>=3 || cantodefesa-canto>=3) {
					System.out.println("GOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLLLLLLLLLL!!");
					TimeUnit.SECONDS.sleep(1);
					System.out.println("GOLEIRO DE UM LADO, BOLA DO OUTRO! O "+this.getNomeJogador().toUpperCase()+" NEM SAIU NA FOTO!");
					return true;
				} else {
			...
			if(i==1) {
				...
				if(canto==cantodefesa) {
					System.out.println("DEFEEEEEEENDEEEEEEEEEEEEEEEUUUUUU, "+this.getNomeJogador().toUpperCase()+"!!");
					TimeUnit.SECONDS.sleep(1);
				...
				if(canto-cantodefesa>=3 || cantodefesa-canto>=3) {
					System.out.println("GOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLLLLLLLLLL!!");
					TimeUnit.SECONDS.sleep(1);
					System.out.println("QUE CATEGORIA! GOLEIRO DE UM LADO, BOLA DO OUTRO! O "+this.getNomeJogador().toUpperCase()+" NEM SAIU NA FOTO!");
					return true;
				} else if(cantodefesa==canto) {
					System.out.println("GOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOLLLLLL!!");
					TimeUnit.SECONDS.sleep(1);
					System.out.println("QUE FALHA DO GOLEIRO! O CHUTE FOI MUITO FRACO, MAS MESMO ASSIM O "+this.getNomeJogador().toUpperCase()
